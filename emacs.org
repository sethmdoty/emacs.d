...
**** Olivetti
A minor mode for a nice writing environment.  This helps improve general word procesning type features
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
 (use-package org
   ...
   (setq org-agenda-files (list "~/Documents/org/org_files/"))
   :bind
   (("C-c l" . 'org-store-link)
    ("C-c a" . 'org-agenda)
    ("C-c c" . 'org-capture))
   :config
   (setq org-directory "~/Documents/org/org_files/")
...
:END:")
  ...
  (org-capture-templates
    `(("l" "Links" entry (file my/create-zet-file),
     ...
     ("c" "Contact" entry (file+headline "~/Documents/org/contacts/contacts.org" "Contacts"),
      my/org-contacts-template
      :empty-lines 1)
     
     ("p" "Project Entry" entry (file "~/Documents/org/org_files/projects.org"),
     ...
     ("f" "File email (mu4e)" entry (file+headline "~/Documents/org/org_files/todo.org" "Email")
                   "* %a by [[mailto:%:fromaddress][%:fromname]]\n%U\n\n%i%?\n")

     ("t" "Task" entry (file+headline "~/Documents/org/org_files/todo.org" "Tasks"),
...
(use-package org-contacts
  :ensure nil
  :after org
  :custom (org-contacts-files '("~/Documents/org/contacts/contacts.org")))
#+END_SRC
***** Org Superstar
